...
from .abstract_dataset import AbstractDatasetInfos, MolecularDataModule
...
if __name__ == "__main__":
    # ds = [MOSESDataset(s, "./data/moses", filter_dataset=True) for s in ["train", "val", "test"]]
    train_ds = MOSESDataset('train', "./data/moses", filter_dataset=True)